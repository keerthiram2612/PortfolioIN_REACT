    ...
    <div className="footer">
      <div className="footer-container">
        <div className="left">
            ...
            <div className="email">
            <h4><FaMailBulk size={20} style={{color:"white",marginRight:"2rem"}}/>+91 6382819707</h4>
            </div>
        </div>
        <div className="right">
          <h4>About me</h4>
          <p>This is Keerthana FrontEnd developer .<br/>
            I enjoy discussing new projects and design <br/>
            challenges. </p>
        </div>
